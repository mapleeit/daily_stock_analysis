...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "PERPLEXITY_API_KEYS": {
        ...
        "description": "Comma-separated Perplexity/OpenRouter API keys.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "PERPLEXITY_BASE_URL": {
        ...
        "description": "Base URL for Perplexity/OpenRouter chat completions API.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "PERPLEXITY_MODEL": {
        ...
        "description": "Perplexity model name, e.g. perplexity/sonar-pro-search.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "perplexity/sonar-pro-search",
        "options": [],
        "validation": {},
        "display_order": 54,
    },
